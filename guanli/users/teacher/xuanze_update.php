...
if ($con) 
{ 
$sql = "UPDATE t_dan SET question='$question',answer='$answer',topic_id=$topic_id ,answer_a='$answer_a' ,answer_b='$answer_b' ,answer_c='$answer_c',answer_d='$answer_d' where id=".$id;
